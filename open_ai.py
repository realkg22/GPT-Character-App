...
if __name__ == '__main__':
    ...
    FIRST_SYSTEM_MESSAGE = {"role": "system", "content": "Act like you are Captain Rex from the Star Wars the Clone Wars series!"}
    FIRST_USER_MESSAGE = {"role": "user", "content": "Hello trooper. State your clone trooper code and name please. Please give me a 1 sentence background on how you got here."}
    openai_manager.chat_history.append(FIRST_SYSTEM_MESSAGE)
    openai_manager.chat_history.append(FIRST_USER_MESSAGE)

    while True:
        new_prompt = input("\nType out your next question Clone Trooper Rex, then hit enter: \n")
